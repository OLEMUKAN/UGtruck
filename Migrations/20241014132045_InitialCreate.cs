        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DriverId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    CurrentCapacityPercentage = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TRoutes_Locations_DestinationId",
                        column: x => x.DestinationId,
                        principalTable: "Locations",
                        principalColumn: "LocationId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TRoutes_Locations_OriginId",
                        column: x => x.OriginId,
                        principalTable: "Locations",
                        principalColumn: "LocationId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TRoutes_Trucks_TruckId",
                        column: x => x.TruckId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DrivingHours = table.Column<double>(type: "float", nullable: false),
                    RestHours = table.Column<double>(type: "float", nullable: false),
                    IsOvertime = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DriverSchedules", x => x.ScheduleId);
                    table.ForeignKey(
                        name: "FK_DriverSchedules_AspNetUsers_DriverId",
                        column: x => x.DriverId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DriverSchedules_TRoutes_RouteId",
                        column: x => x.RouteId,
                        principalTable: "TRoutes",
                        principalColumn: "RouteId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeightInTons = table.Column<double>(type: "float", nullable: false),
                    VolumeInCubicFeet = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Load_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "BookingId",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Load_Locations_DeliveryLocationId",
                        column: x => x.DeliveryLocationId,
                        principalTable: "Locations",
                        principalColumn: "LocationId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Load_Locations_PickupLocationId",
                        column: x => x.PickupLocationId,
                        principalTable: "Locations",
                        principalColumn: "LocationId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Load_Shipments_ShipmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DriverSchedules_RouteId",
                table: "DriverSchedules",
                column: "RouteId");

            migrationBuilder.CreateIndex(
                name: "IX_Load_BookingId",
                table: "Load",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_Load_DeliveryLocationId",
                table: "Load",
                column: "DeliveryLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_Load_PickupLocationId",
                table: "Load",
                column: "PickupLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_Load_ShipmentId",
                table: "Load",
                column: "ShipmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TRoutes_OriginId",
                table: "TRoutes",
                column: "OriginId");

            migrationBuilder.CreateIndex(
                name: "IX_TRoutes_TruckId",
                table: "TRoutes",
                column: "TruckId");
